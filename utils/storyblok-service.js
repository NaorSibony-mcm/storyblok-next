...
class StoryblokService {
    constructor() {
        /**In the development phase, it is useful to
         * set the variable this.devMode to true so you
         *  can retrieve unpublished content from the Storyblok API
         *  without the need to use Storyblok’s preview mode. */
        this.devMode = false // Always loads draft
        this.token = '4P1dk9CzGkeyvrDv6tr6ZQtt'
